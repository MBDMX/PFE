...
import { X, History, Activity, Calendar, ArrowUpRight, Brain, CalendarClock, Zap, Plus, ClipboardList } from 'lucide-react';

interface Props {
    machine: any;
    machineOrders: any[];
    loadingOrders: boolean;
    triggeringMaintenance: boolean;
    onClose: () => void;
    onTriggerMaintenance: (m: any) => void;
}
